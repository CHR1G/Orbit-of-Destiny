...
// Cell aspect matches the plane, which matches a tarot card at 100 : 179 —
// so the art is neither squashed nor cropped. The deck is portrait and the
// old 3 : 2 landscape cell was cutting two thirds of every card away.
const CELL_W = 320;
const CELL_H = Math.round((CELL_W * 179) / 100);
