...
A tarot carousel rendered as a single WebGL shader. The 22 Major Arcana ride a
ring that sits mostly off-screen, so you see a tall arc of cards sweeping past.
Scroll, drag or swipe to turn it; it settles with a card facing front, and five
reading modes — a daily draw plus four spreads — open on tap.
...
left, keyword and English title to the right, and the five reading modes top
